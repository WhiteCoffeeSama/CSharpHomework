...
namespace Program2
{
    ...
    class OrderService
    {
        ...
        public Order SearchOrderLinQByGoodsName(string name)
        {
            Order order = listOfOrders
                .Where(s => s.Goods == name)
                .Select(s => s)
                .FirstOrDefault();
        ...
        public Order SearchOrderLinQByClient(string client)
        {
            Order order = listOfOrders
        ...
        public void ShowOrder(Order order)
        {
            ...
            Console.WriteLine("Name\tPrice\tCount\tID\t\t\tClient\n");
            Console.WriteLine(order.Goods + "\t" + order.Detail.Price + "\t" + order.Count + "\t" + order.ID + "\t" + order.Client + "\n");
        }
    }
